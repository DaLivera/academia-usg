            ...
            <div class="row">
                <div class="col-12 col-md-4 col-lg-4 col-xl-4 order-1 order-md-0 align-items-center justify-content-center scroll_for py-5">
                    <div class="col-lg-2 justify-content-center contenedor__formulario">
                        ...
                        <div class="h-100">
                            <form novalidate  role="form" name="contacto" action="send_contacto.php" method="post"
                enctype="multipart/form-data" id ="registro" >
                                <div class="row d-flex align-content-around justify-content-center">
                                    <div class="col-sm-12 col-lg-10 mb-3 contenedor__input">
                                    ...
                                    <div class="col-sm-12 col-lg-10 mb-3 contenedor__input">
                                        <select class="form-select __select" name="programa" aria-label="Default select example">
                                            <option selected>Programas en línea</option>
                                            <option value="Tableros">Tableros</option>
                                            <option value="Plafones Acústicos">Plafones Acústicos</option>
                                            <option value="Sistemas de Suspensión">Sistemas de Suspensión</option>
                                            <option value="Expresión Perfecta">Expresión Perfecta</option>
                                            <option value="Perfiles Metálicos">Perfiles Metálicos</option>
                                    ...
                                    <div class="col-12 col-md-10 col-lg-8 mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="2" id="checkAdP" onclick="valdarAdP()">
        ...
        <section class="que__es__academiausg container-flluid" id="que__es__academiausg">
            <div class="row m-0">
                <div class="col-12 col-lg-6 offset-lg-1">
                    <div class="row">
                        <div class="col-12 m-0 contenedor__tituloh2">
                    ...
                    <div class="row d-flex justify-content-center columna__cursos-02">
                        ...
                        <div class="col-xs-12 col-md-4 d-none d-md-block d-lg-none contenedor__cursos-02">
                            <h3 class="titulos__blancos text-center">
                                Cursos
                            </h3>
                            <ul class="p-0 mb-5 px-5  text-center">
                ...
                <div class="col-12 col-lg-4 columna__cursos">
