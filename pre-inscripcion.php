            ...
            <div class="row">
                <div class="col-12 columna__formulario">
                    ...
                    <div class="contenedor__formulario">
                        <div class="h-100">
                            <form novalidate  role="form" name="registro" action="confirmacion.php" method="post" enctype="multipart/form-data" id ="registro"  onsubmit="return validarRegistro()">
                                ...
                                <input type="hidden" name="horario" value="<?php echo $info['horario'];?>">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-lg-4 mb-3 contenedor__input">
                                            <input class="__input w-100" type="text" class="form-control required" name="nombre" id="floatingNombre" placeholder="Nombre(s)" required>
                                        </div>
                                        <div class="col-12 col-lg-4 mb-3 contenedor__input">
